...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("ODS TECHNOLOGIES,233596780685")
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'ODS TECHNOLOGIES' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'false' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'ODS-TECHNOLOGIES' : process.env.PACK_NAME.split(";")[1],
  ...
  HEROKU: {
    ...
    API_KEY: process.env.HEROKU_API_KEY === undefined ? 'HRKU-7b989f65-962b-4365-8ff5-2e860b08ec6b' : process.env.HEROKU_API_KEY,
    APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'pantherme' : process.env.HEROKU_APP_NAME
},
